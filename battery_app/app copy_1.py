...
app.layout = html.Div([
    ...
    dcc.Graph(id='plot-display', style={'display': 'flex', 'justifyContent': 'center', 'alignItems': 'center', 'height': '80vh'}),
...
def update_output(contents, filename):
    ...
    try:
        if 'txt' in filename:
            ...
            fig.update_layout(title='Potential vs. SoC for Multiple Cycles', xaxis_title='State of Charge (SoC)', yaxis_title='Ewe/V')
